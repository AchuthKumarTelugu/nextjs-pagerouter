...
const Contact = () => {
  ...
  return (
    <div className=' h-[90vh] flex flex-col'>
      ...
      <div className='w-1/2 mx-auto bg-black color-white py-4  rounded shadow-lg ' >
        ...
        <form onSubmit={handleSubmit}
          ...
          <button type='submit' className='bg-pink-400 text-white px-4 py-2 rounded text-xl mb-10 '>Submit</button>
        </form>
      </div>
       </div>
    </div>
